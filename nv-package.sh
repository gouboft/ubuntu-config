...
if [ -d ~/Source/amlogic/nvidia/kernel/out/G0 ]; then
    cp -v ~/Source/amlogic/nvidia/kernel/out/G0/2n/ZT280.kernel /media/GOUBO/zt-update/
elif [ -d ~/Source/amlogic/nvidia/kernel/out/H1 ]; then
    cp -v ~/Source/amlogic/nvidia/kernel/out/H1/1n/ZT280.kernel /media/GOUBO/zt-update/
else
